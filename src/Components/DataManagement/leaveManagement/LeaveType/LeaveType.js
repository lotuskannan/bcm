...
class LeaveType extends Component {
   constructor(props) {
    ...
    AddLeaveTypeModelHide=()=>{
        this.setState({AddLeaveTypeModelShow:false});
    }
    AddLeaveTypeModelShow=()=>{
        this.setState({AddLeaveTypeModelShow:true});
    }
    render() {
      ...
      return (
        ...
        {            
            this.state.AddLeaveTypeModelShow == true ?(
                <AddLeaveType AddLeaveTypeModelShow={this.state.AddLeaveTypeModelShow} 
                AddLeaveTypeModelHide={this.AddLeaveTypeModelHide}></AddLeaveType>
            ):null        
        }
            ...
            <div className="accordion__item">
                <div className="accordion__button">
                    <div className="accordionHeader">
                        <div><h5>Manage Leave Type</h5></div>                             
                    </div> 
                    <div className="tableSearch">
                        ...
                        <div className="download-icon add">
                            <img src={thinPlus} alt="download Icon" onClick={this.AddLeaveTypeModelShow}/>
                        </div>      
                        </div>               
                    </div>        
                </div>                
