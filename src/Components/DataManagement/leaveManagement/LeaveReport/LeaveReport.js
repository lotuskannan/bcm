      ...
      return (
            ...
            <div className="accordion__item">
                <div className="accordion__button">
                    <div className="accordionHeader">
                        <div><h5>Employee Shift Details</h5></div>                             
                    </div> 
                    <div className="tableSearch">
                        <div className=" ml-auto d-flex">
                        <div className="filterSection ml-2 mr-2" onClick={this.filterAreaShow}>
            ...
            </div>    
        {
            this.state.filterAreaShow == true ?(
                <div className="filterContent leave-report-filter">
                <div className="form1">
                ...
                <div className="form1">
                    ...
                    <Form.Control type="text" placeholder="Select Status" />
                    </form>
                </div>
                <div className="form1">
                    <form class="serach-form">
