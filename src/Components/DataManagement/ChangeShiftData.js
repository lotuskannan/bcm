...
class ChangeShiftData extends Component {
    ...
    render() {
        return (
            <Modal id="addSurveyQuestion" show={this.state.ChangeShiftModelShow} onHide={this.setModalHide} size="sm"
                ...
                <Row>
                    <Col xl="12">
                        <Row className="">
                            ...
                            <Col xs={3} sm="3" xl="4" className="addPlantForm align-items-start">
